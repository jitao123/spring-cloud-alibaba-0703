...
/**
 * @description: 阿里巴巴的simpleimage 对图片的操作
 * @author: AT
 * @Date: 2020/8/22 9:51 上午
 */
public class ImageUtils {
//
//    private static String WATER_IMAGE_URL="E:\\sdIdeaProject\\robot-web\\spring-cloud-alibaba-0703\\shop-common\\src\\main\\resources\\imgFile\\lzsdWaterMark.jpg";
//    protected static ImageFormat outputFormat = ImageFormat.JPEG;
//    private static  String inputPath="E:\\sdIdeaProject\\robot-web\\spring-cloud-alibaba-0703\\shop-common\\src\\main\\resources\\imgFile\\测试2.jpg";
//    private static  String target="E:\\sdIdeaProject\\robot-web\\spring-cloud-alibaba-0703\\shop-common\\src\\main\\resources\\imgFile\\测试1.jpg";
//
//    public static void main(String[] args) {
//        // 1.等比例缩放 缩放的宽和高不能超过原图片的宽高
////        scaleNormal(inputPath, target, 100, 180);
//
//        //  2.等比例缩放加水印
//
////        SimpleImageTool simpleImageTool = new SimpleImageTool();
//        scaleWithWaterMark(inputPath, target,100, 100);
//
//    }
//
//
...
////            double resultX = p.getX() > 0 ? p.getX() : Math.abs(p.getX());
//            double resultX = 100;
////            double resultY = p.getY() > 0 ? p.getY() : Math.abs(p.getY());
//            double resultY = 100;
//            WatermarkParameter param = new WatermarkParameter(waterWrapper, 1f,(int) resultX,(int) resultY);
